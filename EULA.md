...
- 最终解释权归本模块作者所有。
- 未尽之处，以下方「迹•状态栏通知 最终用户许可协议与隐私条款」为准。
如果您还有疑问，请阅读下方文本。

---

# 迹•状态栏通知 最终用户许可协议与隐私条款

*版本 1.1.1 (2022.1.12)*

请您务必仔细阅读和理解 迹•状态栏通知 最终用户许可协议（以下简称「本协议」或「此协议」）与隐私条款。在开始之前，您需要决定是否同意本协议与隐私条款。除非您理解并接受此协议与隐私条款，否则此模块不得在您的任何终端上安装或使用。
